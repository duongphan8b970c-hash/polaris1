...
export default function TableGoalList({
  ...
  // Khi lọc riêng "đã hoàn thành" thì mở sẵn nhóm này.
        ...
        <table className="min-w-full">
          ...
          <tbody>
            ...
            {completedGoals.length > 0 && (
              <>
                <tr
                  className="bg-gray-50 border-t-2 border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors"
                  ...
                  <td colSpan={7} className="px-4 py-2">
                    <div className="flex items-center gap-2 text-xs font-semibold text-gray-600">
                      ...
                      <span className="ml-1 font-normal text-gray-400">
                        {showCompleted ? '— nhấn để thu gọn' : '— nhấn để xem'}
                      </span>
                    </div>
                  </td>
                </tr>
