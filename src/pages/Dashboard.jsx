...
export default function Dashboard() {
  ...
  const stats = useMemo(() => {
    ...
    console.log('📊 Dashboard Stats:', {
      ...
      monthlyClosedTrades: monthlyClosedTrades.length,
      transactionIncome,
    ...
    return {
      ...
      income: transactionIncome, // ✅ Will add trade P&L after conversion
      incomeCount,
      expense,
      expenseCount,
      tradePL: 0, // ✅ Will be set by useEffect
      tradeCount,
      monthlyClosedTrades, // ✅ Pass to useEffect
      topCategories,
      recentTransactions,
  ...
  useEffect(() => {
    const convertTradePL = async () => {
      if (!stats.monthlyClosedTrades || stats.monthlyClosedTrades.length === 0) {
      ...
      for (const trade of stats.monthlyClosedTrades) {
        ...
        console.log(`💱 Convert ${trade.symbol}:`, {
          pl,
          currency,
          rate,
          plInVND
      ...
      console.log('💰 Total Trade P&L in VND:', totalVND)
      setTradePLConverted(totalVND)
    }

    convertTradePL()
  }, [stats.monthlyClosedTrades])

  // ✅ Use converted value in display
  const displayStats = {
    ...stats,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* STATS CARDS - 6 LARGE CARDS */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        
        {/* 1. Total Balance */}
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right">
              <p className="text-blue-100 text-sm font-bold uppercase tracking-wider">Tổng Tài Sản</p>
              <p className="text-blue-200 text-xs mt-1">{displayStats.walletCount} ví</p>
            </div>
          </div>
          <div className="space-y-2">
            <p className="text-5xl font-bold tracking-tight leading-none">
              {displayStats.totalBalance.toLocaleString('vi-VN')}
            </p>
            <p className="text-blue-100 text-lg font-semibold">VND</p>
          </div>
        </div>

        {/* 2. Income */}
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between mb-6">
            <div className="p-4 bg-white/20 backdrop-blur-sm rounded-2xl">
              <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* 3. Expense */}
        <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between mb-6">
            <div className="p-4 bg-white/20 backdrop-blur-sm rounded-2xl">
              <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="text-right">
              <p className="text-red-100 text-sm font-bold uppercase tracking-wider">Chi Tiêu</p>
              <p className="text-red-200 text-xs mt-1">{displayStats.expenseCount} giao dịch</p>
            </div>
          </div>
          <div className="space-y-2">
            <p className="text-5xl font-bold tracking-tight leading-none">
            ...
            <p className="text-red-100 text-lg font-semibold">VND tháng này</p>
          </div>
        </div>

        {/* 4. Trade P&L */}
        <div className={`rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 ${
          displayStats.tradePL >= 0 
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right">
              <p className="text-purple-100 text-sm font-bold uppercase tracking-wider">Trade P&L</p>
              <p className="text-purple-200 text-xs mt-1">{displayStats.tradeCount} lệnh đóng</p>
            </div>
          </div>
          <div className="space-y-2">
            <p className="text-5xl font-bold tracking-tight leading-none">
            ...
            <p className="text-purple-100 text-lg font-semibold">VND tổng P&L</p>
          </div>
        </div>

        {/* 5. Total Transactions */}
        <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between mb-6">
            <div className="p-4 bg-white/20 backdrop-blur-sm rounded-2xl">
              <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="text-right">
              <p className="text-cyan-100 text-sm font-bold uppercase tracking-wider">Giao Dịch</p>
              <p className="text-cyan-200 text-xs mt-1">Tháng này</p>
            </div>
          </div>
          <div className="space-y-2">
            <p className="text-5xl font-bold tracking-tight leading-none">
            ...
            <p className="text-cyan-100 text-lg font-semibold">
              {displayStats.incomeCount} thu / {displayStats.expenseCount} chi
            </p>
          </div>
        </div>

        {/* 6. Savings Rate */}
        <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-3xl p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between mb-6">
            <div className="p-4 bg-white/20 backdrop-blur-sm rounded-2xl">
              <svg className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="text-right">
              <p className="text-amber-100 text-sm font-bold uppercase tracking-wider">Tỷ Lệ Tiết Kiệm</p>
              <p className="text-amber-200 text-xs mt-1">Savings Rate</p>
            </div>
          </div>
          <div className="space-y-2">
            <p className="text-5xl font-bold tracking-tight leading-none">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          {displayStats.recentTransactions.length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm mt-1">Thêm giao dịch đầu tiên của bạn</p>
            </div>
          )}
        </div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 md:p-6 border-2 border-gray-200">
        <div className="flex items-center gap-3 text-gray-700">
          ...
          <p className="text-sm font-medium">
            ...
            Trade P&L đã được quy đổi sang VND theo tỷ giá hiện tại.
          </p>
        </div>
      </div>
