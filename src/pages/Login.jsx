  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        {/* Fallback nếu browser không support video */}
        Your browser does not support the video tag.
      </video>

      {/* ✅ DARK OVERLAY - Làm mờ video để text dễ đọc */}
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm"></div>

      {/* ✅ GRADIENT OVERLAY - Tạo hiệu ứng gradient */}
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="backdrop-blur-2xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Quản lý tài chính thông minh</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-white/10 text-blue-500 focus:ring-white/50"
                />
            ...
            <div className="text-center">
              ...
              >
                {isSignUp ? (
                  ...
                  <>Chưa có tài khoản? <span className="underline">Đăng ký</span></>
                )}
              </button>
            </div>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="py-3 px-4 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-medium rounded-xl transition-all backdrop-blur-sm flex items-center justify-center gap-2">
